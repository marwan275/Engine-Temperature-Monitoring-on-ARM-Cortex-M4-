...
Dio_PortLevelType Dio_ReadChannelGroup(const Dio_ChannelGroupType* ChannelGroupIdPtr)
{
    ...
    /* Check if the used channel group pointer is not a NULL_PTR */
    ...
    if (FALSE == error)
    {
        /* Point to the correct PORT register according to the Port Index stored in the PortIndex member */
        ...
        /* Read the required channel group using masking and shifting */
        output = ((*Port_Ptr >> ChannelGroupIdPtr->offset) & ChannelGroupIdPtr->mask);
    }
    else
    {
        /* No Action Required */
...
void Dio_WriteChannelGroup(const Dio_ChannelGroupType* ChannelGroupIdPtr, Dio_PortLevelType Level)
{
    ...
    if (FALSE == error)
    {
        ...
        /* Write the required channel group using masking and shifting */
        *Port_Ptr = (*Port_Ptr & ~(ChannelGroupIdPtr->mask << ChannelGroupIdPtr->offset)) |
                     ((Level & ChannelGroupIdPtr->mask) << ChannelGroupIdPtr->offset);
    }
    else
    {
        /* No Action Required */
